...
let displayStr = `<p>A total of $${amountRaised.toLocaleString(
  "en-US"
)} has been raised for ${totalGames} ${totalGames === 1 ? "game" : "games"}. 
    Currently, ${unfundedTotal} ${
  unfundedTotal === 1 ? "game remains unfunded." : "games remain unfunded."
}
